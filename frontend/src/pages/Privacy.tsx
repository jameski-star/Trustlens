    ...
    <>
      ...
      <div className="container-page py-8">
        ...
        <div className="max-w-3xl mx-auto">
          <h1 className="font-heading font-700 text-xl md:text-4xl text-[var(--text-primary)] mb-4 text-wrap: balance">Privacy Policy</h1>
          ...
          <div className="prose prose-slate max-w-none dark:prose-invert text-[var(--text-secondary)] leading-relaxed">
            ...
            <h2>Contact</h2>
            <p>For privacy-related inquiries, contact us through our <a href="/contact" className="text-[var(--text-accent)] underline underline-offset-2">contact page</a>.</p>
          </div>
        </div>
      </div>
